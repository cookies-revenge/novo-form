...
use Test\Models\Bookstore;
use Test\Models\BookstoreQuery;


/**
 * This class defines the structure of the 'nft__bookstores' table.
 *
 *
 *
...
class BookstoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Test.Models.Map.BookstoreTableMap';
     ...
     */
    const TABLE_NAME = 'nft__bookstores';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Test\\Models\\Bookstore';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Test.Models.Bookstore';
     ...
     */
    const COL_ID = 'nft__bookstores.id';

    /**
     * the column name for the crdate field
     */
    const COL_CRDATE = 'nft__bookstores.crdate';

    /**
     * the column name for the tstamp field
     */
    const COL_TSTAMP = 'nft__bookstores.tstamp';

    /**
     * the column name for the title field
     */
    const COL_TITLE = 'nft__bookstores.title';

    /**
     * the column name for the city field
     */
    const COL_CITY = 'nft__bookstores.city';

    /**
     * the column name for the address field
     */
    const COL_ADDRESS = 'nft__bookstores.address';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Crdate', 'Tstamp', 'Title', 'City', 'Address', ),
        self::TYPE_CAMELNAME     => array('id', 'crdate', 'tstamp', 'title', 'city', 'address', ),
        self::TYPE_COLNAME       => array(BookstoreTableMap::COL_ID, BookstoreTableMap::COL_CRDATE, BookstoreTableMap::COL_TSTAMP, BookstoreTableMap::COL_TITLE, BookstoreTableMap::COL_CITY, BookstoreTableMap::COL_ADDRESS, ),
        self::TYPE_FIELDNAME     => array('id', 'crdate', 'tstamp', 'title', 'city', 'address', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Crdate' => 1, 'Tstamp' => 2, 'Title' => 3, 'City' => 4, 'Address' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'crdate' => 1, 'tstamp' => 2, 'title' => 3, 'city' => 4, 'address' => 5, ),
        self::TYPE_COLNAME       => array(BookstoreTableMap::COL_ID => 0, BookstoreTableMap::COL_CRDATE => 1, BookstoreTableMap::COL_TSTAMP => 2, BookstoreTableMap::COL_TITLE => 3, BookstoreTableMap::COL_CITY => 4, BookstoreTableMap::COL_ADDRESS => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'crdate' => 1, 'tstamp' => 2, 'title' => 3, 'city' => 4, 'address' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    {
        // attributes
        $this->setName('nft__bookstores');
        $this->setPhpName('Bookstore');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\Test\\Models\\Bookstore');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BookstoreTableMap::COL_CRDATE);
            $criteria->addSelectColumn(BookstoreTableMap::COL_TSTAMP);
            $criteria->addSelectColumn(BookstoreTableMap::COL_TITLE);
            $criteria->addSelectColumn(BookstoreTableMap::COL_CITY);
            $criteria->addSelectColumn(BookstoreTableMap::COL_ADDRESS);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Test\Models\Bookstore) { // it's a model object
