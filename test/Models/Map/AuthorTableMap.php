...
use Test\Models\AuthorQuery;


/**
 * This class defines the structure of the 'nft__authors' table.
 *
 *
 *
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Test.Models.Map.AuthorTableMap';
     ...
     */
    const TABLE_NAME = 'nft__authors';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Test\\Models\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Test.Models.Author';
     ...
     */
    const COL_ID = 'nft__authors.id';

    /**
     * the column name for the crdate field
     */
    const COL_CRDATE = 'nft__authors.crdate';

    /**
     * the column name for the tstamp field
     */
    const COL_TSTAMP = 'nft__authors.tstamp';
    ...
    {
        // attributes
        $this->setName('nft__authors');
        $this->setPhpName('Author');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\Test\\Models\\Author');
    ...
    {
        $this->addRelation('Book', '\\Test\\Models\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Test\Models\Author) { // it's a model object
